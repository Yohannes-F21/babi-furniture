      ...
      <main className="flex-1 lg:ml-64 p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mt-2">Welcome back to Alpha Furniture Admin!</p>
          </div>

          {/* Stats Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            {[
              { icon: Package, label: "Total Products", value: "145", color: "bg-blue-50" },
              { icon: Users, label: "Total Customers", value: "567", color: "bg-green-50" },
              { icon: TrendingUp, label: "Total Orders", value: "1230", color: "bg-purple-50" },
              { icon: BarChart3, label: "Revenue", value: "2,45,000 Br", color: "bg-amber-50" },
            ].map((stat, index) => {
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <p className="text-sm text-gray-600">Create a new furniture item</p>
                </button>
                <button

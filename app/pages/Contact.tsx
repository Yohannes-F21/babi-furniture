      ...
      <section className="bg-gradient-to-r from-amber-50 to-orange-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Get in touch with us for quotes, custom orders, or any questions about our furniture
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">0979 426642</p>
                    <p className="text-gray-600">0979420042</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@alphafurniture.net</p>
                  </div>
                </div>
              ...
              {/* Showroom Locations */}
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-6">Visit Our Showrooms</h3>
                <div className="space-y-6">
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="flex items-start space-x-4">
                      <MapPin className="w-6 h-6 text-amber-600 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">Beklo Bet Showroom</h4>
                        <p className="text-gray-600 mb-2">Opposite Alpha Building</p>
                        <p className="text-sm text-gray-500">
                          Our main showroom featuring the complete furniture collection
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="flex items-start space-x-4">
                      <MapPin className="w-6 h-6 text-amber-600 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">Salete Mehret Showroom</h4>
                        <p className="text-gray-600 mb-2">Behind 3F</p>
                        <p className="text-sm text-gray-500">Specialized in bedroom and dining room furniture</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 bg-gray-50 rounded-lg">
                    <div className="flex items-start space-x-4">
                      <MapPin className="w-6 h-6 text-amber-600 mt-1 flex-shrink-0" />
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-2">Gurd Shola Showroom</h4>
                        <p className="text-gray-600 mb-2">Opposite Ethio Telecom</p>
                        <p className="text-sm text-gray-500">Focus on living room furniture and custom orders</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Visit any of our convenient locations in Addis Ababa</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            <div className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center mb-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-500">Call us for detailed directions to any of our showrooms</p>
              </div>
            </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-amber-400 mb-4">Alpha Furniture Ethiopia</h3>
            <p className="text-gray-300 mb-4">
              19+ years of experience in providing quality furniture with custom designs, free delivery in Addis Ababa,
              and two-year warranty.
            </p>
            <div className="space-y-2">
              <div className="flex items-center">
                <Phone size={16} className="mr-2 text-amber-400" />
                <span>0979 426642 / 0979420042</span>
              </div>
              <div className="flex items-center">
                <Mail size={16} className="mr-2 text-amber-400" />
                <span>info@alphafurniture.net</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start">
                <MapPin size={16} className="mr-2 text-amber-400 mt-0.5 flex-shrink-0" />
                <span className="text-gray-300">Beklo Bet (Opposite Alpha Building)</span>
              </div>
              <div className="flex items-start">
                <MapPin size={16} className="mr-2 text-amber-400 mt-0.5 flex-shrink-0" />
              ...
              <div className="flex items-start">
                <MapPin size={16} className="mr-2 text-amber-400 mt-0.5 flex-shrink-0" />
                <span className="text-gray-300">Gurd Shola (Opp Ethio Telecom)</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2025 Alpha Furniture Ethiopia. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
